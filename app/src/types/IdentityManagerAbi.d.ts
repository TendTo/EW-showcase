...
interface IdentityManagerAbiInterface extends ethers.utils.Interface {
  functions: {
...
export class IdentityManagerAbi extends BaseContract {
  ...
  interface: IdentityManagerAbiInterface;
